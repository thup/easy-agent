...
public enum TypeMatcher {
    ...
    private ElementMatcher.Junction<NamedElement> ignoreRule = nameStartsWith("java.")
            ...
            .or(nameStartsWith("java.base."))
            .or(nameStartsWith("sun.instrument."))
            .or(nameStartsWith("jdk.internal.reflect."))
            .or(nameStartsWith("org.openqa."))
            .or(nameStartsWith("groovy.lang."))
            .or(nameStartsWith("org.codehaus.groovy."))
            .or(nameStartsWith("org.apache.groovy."))
            .or(nameStartsWith("jdk.nio."))
            .or(nameStartsWith("org.yaml.snakeyaml."))
            .or(nameStartsWith("org.apache.http."))
            .or(nameStartsWith("groovy.transform."))
            .or(nameStartsWith("org.jcp.xml.dsig."))
            .or(nameStartsWith("groovy.json."))
            .or(nameStartsWith("groovy.io."))
            .or(nameStartsWith("groovy.grape."))
            .or(nameStartsWith("groovy.transform."))
            .or(nameStartsWith("groovyjarjarantlr4.v4."))
            .or(nameStartsWith("io.qameta.allure."))
            .or(nameStartsWith("com.github.javafaker."))
            .or(nameStartsWith("ch.qos.logback."))
            //.or(nameContains(".appium."))
